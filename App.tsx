    ...
    <ScrollView>
      ...
      <View style={styles.container}>
        <View style={{ paddingTop: 10, paddingBottom: 25 }}>
          <Image source={{ uri: 'https://via.org.vn/datafiles/setone/1616472685_ACCESSTRADE_logo-new-2021-square-02.png' }} style={{ width: 200, height: 110 }} />
        </View>
...
const TabNavigator: React.FC = () => {
  return (
    ...
    >
      ...
      <Tab.Screen name="Newsletter" component={Newsletter} options={{ title: 'Newsletter' }} />
      <Tab.Screen name="Job" component={Job} options={{ title: 'Jobs' }} />
      <Tab.Screen name="Report" component={Report} options={{ title: 'Reports' }} />
